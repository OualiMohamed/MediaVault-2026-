                ...
                <div class="flex items-center justify-between h-14 sm:h-16 gap-3">
                    ...
                    <div class="flex items-center gap-2 sm:gap-3 flex-shrink-0">
                        ...
                        <button @click="toggleTheme"
                            class="w-9 h-9 rounded-lg flex items-center justify-center text-vault-300 hover:text-white hover:bg-vault-700 transition-all flex-shrink-0"
                            :title="theme === 'dark' ? 'Switch to Light Mode' : 'Switch to Dark Mode'">
                            <svg v-if="theme === 'dark'" class="w-5 h-5" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round"
