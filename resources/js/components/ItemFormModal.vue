...
async function applyTmdbData(data) {
    ...
    if (data.franchise_position) form.franchise_position = data.franchise_position
...
async function applyGoogleBooksData(data) {
    ...
    if (data.series) form.series_name = data.series
    if (data.series_position) form.series_position = data.series_position
}
