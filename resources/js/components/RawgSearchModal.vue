...
async function doSearch() {
    ...
    results.value = []
    try {
        const { data } = await api.post('/rawg/search', { query: query.value })
            ...
            <div
                ...
                <div class="flex items-center justify-between px-5 py-4 border-b border-vault-700 flex-shrink-0">
                    <div class="flex items-center gap-2.5">
                        <div class="w-8 h-8 rounded-lg bg-sky-500/15 flex items-center justify-center">🎮</div>
                        <h2 class="text-white font-semibold">Search RAWG</h2>
                    </div>
                ...
                <div class="px-5 py-3 border-b border-vault-700 flex-shrink-0">
                    <div class="relative">
                        ...
                        <input ref="searchInput" v-model="query" type="text" @input="onSearchInput"
                            ...
                            placeholder="Search for a game..." autocomplete="off" />
                    ...
                    <p class="text-vault-500 text-xs mt-1.5">Powered by RAWG Video Games Database</p>
                </div>
                    ...
                    <div v-else>
                        ...
                        <div v-if="query.length < 2" class="text-center py-12">
                            <div
                                ...
                                🎮</div>
                            <p class="text-vault-400 text-sm">Search for a game to auto-fill details and cover</p>
                        </div>
                    </div>
                </div>
